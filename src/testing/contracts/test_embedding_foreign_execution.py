...
FIXTURE = ROOT / "src/testing/contracts/fixtures/embedding/branches/foreign-execution/atom.embedding.14.foreign-execution.orc-ownership"
        ...
        with tempfile.TemporaryDirectory(prefix="monadc-foreign-execution-") as directory:
            ...
            result = subprocess.run(
                ["cc", *flags, "-std=c99", "-Wall", "-Wextra", "-Werror",
                 "-iquote", str(ROOT / "src"), "-I", str(ROOT / "embed/include"),
