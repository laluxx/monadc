"""A typed handle explicitly controls a frozen native pointer lifetime."""
...
FIXTURE = ROOT / "src/testing/contracts/fixtures/embedding/branches/live-source/atom.embedding.42.live-source.releasable-function"


class ReleasableFunctionTests(unittest.TestCase):
    def test_installed_surface_releases_frozen_image(self):
        with tempfile.TemporaryDirectory(prefix="monadc-release-function-") as directory:
