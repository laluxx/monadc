...
class CliFlagDualityTests(unittest.TestCase):
    ...
    def test_cli_common_options_can_prefix_real_subcommands(self):
        ...
        self.assertIn("python3 -B -m src.testing.suites %s", cli_c)
    ...
    def test_usage_menu_lists_flag_word_duality_and_eval_help(self):
        ...
        self.assertIn("monad -jit file.mon", completion_c)
        self.assertIn("monad test [list|runner|core|laws|windows|how-to|file.mon]", completion_c)
        self.assertIn("Suites: list, runner, core, laws, windows, how-to, cmake, readme, bytecode, all", completion_c)
