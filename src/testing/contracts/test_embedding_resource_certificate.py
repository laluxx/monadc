"""Installed QTT evidence advances only after typed-Core verification."""
...
FIXTURE = ROOT / "src/testing/contracts/fixtures/embedding/branches/introspection/atom.embedding.36.introspection.resource-certificate"


class ResourceCertificateTests(unittest.TestCase):
    def test_installed_report_exposes_verified_resource_certificate(self):
        with tempfile.TemporaryDirectory(prefix="monadc-resource-certificate-") as directory:
