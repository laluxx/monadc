"""Environment snapshots provide indexed and filtered editor queries."""
...
FIXTURE = ROOT / "src/testing/contracts/fixtures/embedding/branches/introspection/atom.embedding.31.introspection.indexed-environment"


class EnvironmentQueryTests(unittest.TestCase):
    def test_installed_sdk_queries_owned_definition_metadata(self):
        with tempfile.TemporaryDirectory(prefix="monadc-environment-query-") as directory:
