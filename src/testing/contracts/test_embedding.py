...
FIXTURE = ROOT / "src/testing/contracts/fixtures/embedding/branches/lifecycle/atom.embedding.01.lifecycle.opaque-runtime"
NATIVE_FIXTURE = ROOT / "src/testing/contracts/fixtures/embedding/branches/native-call/atom.embedding.02.native-call.zero-wrapper"
BIDIRECTIONAL_FIXTURE = ROOT / "src/testing/contracts/fixtures/embedding/branches/bidirectional/atom.embedding.03.bidirectional.zero-wrapper"
LIVE_FIXTURE = ROOT / "src/testing/contracts/fixtures/embedding/branches/live-image/atom.embedding.04.live-image.function-cell"
SNAPSHOT_FIXTURE = ROOT / "src/testing/contracts/fixtures/embedding/branches/live-image/atom.embedding.05.live-image.snapshot-values"
FOREIGN_FIXTURE = ROOT / "src/testing/contracts/fixtures/embedding/branches/foreign-object/atom.embedding.06.foreign-object.nominal-lifetime"
EXECUTOR_FIXTURE = ROOT / "src/testing/contracts/fixtures/embedding/branches/foreign-object/atom.embedding.07.foreign-object.executor-ownership"
TYPE_REFLECTION_FIXTURE = ROOT / "src/testing/contracts/fixtures/embedding/branches/foreign-object/atom.embedding.08.foreign-object.generative-reflection"
COMPILER_IMPORT_FIXTURE = ROOT / "src/testing/contracts/fixtures/embedding/branches/compiler-session/atom.embedding.10.compiler-session.transactional-foreign-import"
INSTALLED_FIXTURE = ROOT / "src/testing/contracts/fixtures/embedding/branches/installed-sdk/atom.embedding.13.installed-sdk.c-cpp-static-shared"
SOURCE_FIXTURE = ROOT / "src/testing/contracts/fixtures/embedding/branches/source-unit/atom.embedding.15.source-unit.owned-versioned-buffer"
DIAGNOSTIC_FIXTURE = ROOT / "src/testing/contracts/fixtures/embedding/branches/diagnostics/atom.embedding.16.diagnostics.immutable-input-check"
...
class EmbeddingApiTests(unittest.TestCase):
    ...
    def test_embedding_c_fixtures_have_living_metadata(self):
        fixtures = list((ROOT / "src/testing/contracts/fixtures/embedding").rglob("host.c"))
        fixtures += list((ROOT / "src/testing/contracts/fixtures/embedding").rglob("host.cpp"))
        fixtures += [
            ROOT / "src/testing/contracts/fixtures/qtt/branches/foreign-call/atom.qtt.09.foreign-call.nominal-transfer/host.c",
            ROOT / "src/testing/contracts/fixtures/qtt/branches/foreign-lowering/atom.qtt.11.foreign-lowering.exact-runtime-actions/host.c",
            ROOT / "src/testing/contracts/fixtures/qtt/branches/foreign-llvm/atom.qtt.12.foreign-llvm.verified-direct-calls/host.c",
        ]
