"""Installed QTT reports distinguish inferred evidence from resource proof."""
...
FIXTURE = ROOT / "src/testing/contracts/fixtures/embedding/branches/introspection/atom.embedding.34.introspection.qtt-inference-evidence"


class QttReportTests(unittest.TestCase):
    def test_installed_report_owns_real_inference_evidence(self):
        with tempfile.TemporaryDirectory(prefix="monadc-qtt-report-") as directory:
