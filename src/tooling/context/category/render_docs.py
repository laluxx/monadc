...
def render(root: Path) -> str:
    ...
    lines.append("#+AUTHOR: src/tooling/context/category/render_docs.py")
    ...
    lines.append(":SOURCE: src/tooling/context/category/render_docs.py")
    lines.append(":CONFIDENCE: high")
    lines.append(":END:")
    lines.append("")
    lines.append("[DOC id:doc.category.generated.summary src:src/tooling/context/category/render_docs.py conf:high]")
    ...
    lines.append(":CONTEXT_KIND: generated-report")
    lines.append(":CONTEXT_STATUS: generated")
    lines.append(":SOURCE: src/tooling/context/category/info_metrics.py")
    lines.append(":CONFIDENCE: high")
    lines.append(":END:")
    lines.append("")
